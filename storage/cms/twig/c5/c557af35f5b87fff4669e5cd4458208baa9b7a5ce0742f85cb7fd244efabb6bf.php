...
/* C:\laragon\www\OctoberLaravelOffical\Octoberv5OfficalInstitute/themes/vue-institute/partials/pages/admission.htm */
class __TwigTemplate_a7bdd74200461aa1625bf99c0fb83723fefb24a33db1b22b570af3a91e341d9d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"ttm-row action2-section ttm-bgcolor-darkgrey bg-img7 ttm-bg ttm-bgimage-yes clearfix\">
        <div class=\"ttm-row-wrapper-bg-layer ttm-bg-layer\" style=\"opacity: .82;\"></div>
    ...
    {
        return "C:\\laragon\\www\\OctoberLaravelOffical\\Octoberv5OfficalInstitute/themes/vue-institute/partials/pages/admission.htm";
    }
    ...
    {
        return new Source("<!--action-section-->
    <section class=\"ttm-row action2-section ttm-bgcolor-darkgrey bg-img7 ttm-bg ttm-bgimage-yes clearfix\">
        <div class=\"ttm-row-wrapper-bg-layer ttm-bg-layer\" style=\"opacity: .82;\"></div>
        <div class=\"container\"><!--container-->
            <div class=\"row\"><!--row-->
    ...
    <!--action-section end-->", "C:\\laragon\\www\\OctoberLaravelOffical\\Octoberv5OfficalInstitute/themes/vue-institute/partials/pages/admission.htm", "");
    }
}
