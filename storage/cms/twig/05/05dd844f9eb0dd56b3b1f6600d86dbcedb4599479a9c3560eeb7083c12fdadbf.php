...
/* J:\laragon\www\OctoberLaravelOffical\Octoberv5OfficalInstitute/themes/vue-institute/partials/pages/hisoblagich.htm */
class __TwigTemplate_0cd4c6d6c37d113c7c7b7f595a2ff907cdff820464343a5e3c6e8b8bf7a675e7 extends \Twig\Template
{
    private $source;
    private $macros = [];
 ...
 ";
    ...
    {
        return "J:\\laragon\\www\\OctoberLaravelOffical\\Octoberv5OfficalInstitute/themes/vue-institute/partials/pages/hisoblagich.htm";
    }
        ...
        <section class=\"ttm-row fid-section ttm-bgcolor-darkgrey ttm-bg ttm-bgimage-yes bg-img4 clearfix\" style=\"padding: 80px 0 80px; background-image: url({{ hisob.orqa_fon|media | resize (1900,337, { mode: 'crop', quality: '20' })}});\">
            ...
            <div class=\"container\">
                ...
                <div class=\"row ttm-vertical_sep\">
                    ...
                    {{ notFoundMessage }}
    {% endif %}
{% endfor%}", "J:\\laragon\\www\\OctoberLaravelOffical\\Octoberv5OfficalInstitute/themes/vue-institute/partials/pages/hisoblagich.htm", "");
    }
}
